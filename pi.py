    ...
    # Defining the top
    Label(root, text='Calculator', font=("Comic Sans MS", 15), bg='LightCyan2').place(x=25, y=0)
    Label(root, text='Press \'x\' twice for exponentiation', font=("Georgia", 10), bg='LightCyan2').place(x=30, y=30)

    # Equation Entry Field
    eqn_entry = Entry(root, justify=RIGHT, textvariable=entry_strvar, width=22, font=12)
